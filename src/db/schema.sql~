...
CREATE TABLE users (
    uid integer NOT NULL PRIMARY KEY DEFAULT NEXTVAL('users_id_seq'::regclass),
...
CREATE TABLE messages (
    mid integer NOT NULL PRIMARY KEY DEFAULT NEXTVAL('messages_id_seq'::regclass),
    uid_to integer,
    uid_from integer,
...
ALTER SEQUENCE messages_id_seq OWNED BY messages.mid;
